...
public class orderamalya extends AppCompatActivity {

    String[] fooditems1={"select from here","Chicken fried rice(L) 450.00 lkr","Chicken fried rice(s) 300.00 lkr",
            "Egg fried rice(L) 300.00 lkr","Egg fried rice(s) 200.00 lkr","Special fried rice(R) 500.00 lkr"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderamalya);
        ...
        cashon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendMessage();
                Toast.makeText(orderamalya.this,"Virtual Receipt has been sent to your email!!",Toast.LENGTH_SHORT).show();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(orderamalya.this, PHMainActivity.class);
        ...
        final String LCFR="450";
        final String SCFR="300";
        final String LEFR="300";
        final String SEFR="200";
        final String SFR="500";


        //ITEMS

        final String item1="Chicken Fried Rice (L)";
        final String item2="Chicken Fried Rice (s)";
        final String item3="Egg Fried Rice (L)";
        final String item4="Egg Fried Rice (s)";
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(orderamalya.this);
                ...
                try {
                    ...
                    sender.sendMail("Foodies",
                            "Thank you for using Foodies  " +
                                    " this is your virtual invoice from amalya " +name+
        ...
        final ProgressDialog dialog2 = new ProgressDialog(orderamalya.this);
        dialog.setTitle("Sending Email");
        dialog.setMessage("Please wait");
        dialog.show();
