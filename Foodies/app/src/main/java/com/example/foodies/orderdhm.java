...
public class orderdhm extends AppCompatActivity {

    String[] fooditems1={"select from here","Chicken Burger 450.00 lkr","Chicken wings potion(s) 700.00 lkr",
            "Chicken sandwich 400.00 lkr","Submarines 300.00 lkr","Taco potion 500.00 lkr"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdhm);
        ...
        cashon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendMessage();
                Toast.makeText(orderdhm.this,"Virtual Receipt has been sent to your email!!",Toast.LENGTH_SHORT).show();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(orderdhm.this, PHMainActivity.class);
        ...
        final String item1="Chicken burger (L)";
        final String item2="Chicken wings (s)";
        final String item3="Chicken Sandwich (L)";
        final String item4="Submarine (s)";
        final String item5="Taco(R)";
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(orderdhm.this);
                ...
                try {
                    ...
                    sender.sendMail("Foodies",
                            "Thank you for using Foodies  " +
                                    " this is your virtual invoice from dhm bakery " +name+
        ...
        final ProgressDialog dialog2 = new ProgressDialog(orderdhm.this);
        dialog.setTitle("Sending Email");
        dialog.setMessage("Please wait");
        dialog.show();
