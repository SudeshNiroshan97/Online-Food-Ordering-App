...
public class orderkalana extends AppCompatActivity {

    String[] fooditems1={"select from here","String hoppers meal w/ chicken 250.00 lkr","Hoppers meal 150.00 lkr",
            "Chicken rice and curry 200.00 lkr","Egg Rice and curry (s) 150.00 lkr","Chicken wings 500.00 lkr"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderkalana);
        ...
        cashon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendMessage();
                Toast.makeText(orderkalana.this,"Virtual Receipt has been sent to your email!!",Toast.LENGTH_SHORT).show();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(orderkalana.this, PHMainActivity.class);
        ...
        final String LCFR="250";
        final String SCFR="150";
        final String LEFR="200";
        final String SEFR="150";
        final String SFR="500";


        //ITEMS

        final String item1="String hoppers meal w/ chicken";
        final String item2="Hoppers meal";
        final String item3="Rice and curry w/ chicken";
        final String item4="Egg Rice and curry)";
        final String item5="Chicken wings meal (R)";
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(orderkalana.this);
                ...
                try {
                    ...
                    sender.sendMail("Foodies",
                            "Thank you for using Foodies  " +
                                    " this is your virtual invoice from Kalana foods " +name+
        ...
        final ProgressDialog dialog2 = new ProgressDialog(orderkalana.this);
        dialog.setTitle("Sending Email");
        dialog.setMessage("Please wait");
        dialog.show();
